...
test("formats relative time using the selected locale", () => {
  ...
  assert.equal(formatRelativeTime(new Date("2026-01-01T00:05:00.000Z"), "en", now), "in 5 min");
  assert.equal(formatRelativeTime(new Date("2025-12-31T23:00:00.000Z"), "en", now), "1 hr ago");
...
test("shows a clock time today and a relative day for earlier updates", () => {
  ...
  assert.equal(formatUpdatedTime(earlier.getTime(), "en", now), "3 d ago");
