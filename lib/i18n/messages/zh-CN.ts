...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.saveDisplayName": "保存",
    "settings.appUpdate": "应用更新",
    "settings.checkForUpdatesDescription": "检查已发布版本，或从本地 Pi Web 源代码重新构建。",
    "settings.sourceDirectory": "源代码目录",
    "settings.updateAvailable": "版本 {latest} 可用。当前版本为 {current}。",
    "settings.upToDate": "版本 {current} 已是最新。",
    "settings.updateAndReload": "更新并重新加载",
    "settings.updatingApp": "正在更新…",
    "settings.updateMacOnly": "自动更新和重新加载目前仅支持 macOS。",
    "settings.generalDescription": "选择 Seb 的显示方式和界面语言。",
    ...
    "agents.close": "关闭",
    "agents.builtInTitle": "启用 Seb 内置子代理",
    "agents.builtInDescription": "提供 Seb 集成的 Agent 工具，并停用发生冲突的 pi-subagents 扩展。",
    ...
    "agentSwitcher.noAgents": "尚未启动 Agent",
    "agents.showWorkspace": "显示 Agents 工作区",
    "agents.hideWorkspace": "隐藏 Agents 工作区",
    ...
    "appUpdate.releaseNotes": "Seb v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "主题：浅色",
    "theme.dark": "主题：深色",
    ...
    "session.taskBreakdown": "{count} 个任务",
    "session.task": "任务 {count}",
    ...
    "files.hidePreview": "隐藏实时预览",
    "files.showPreview": "显示实时预览",
    "files.previewUnavailable": "预览不可用",
    "files.panel": "文件",
    "files.noPreviews": "没有打开的预览",
    "files.noneOpen": "没有打开的文件",
    "layout.resizeSidebar": "调整侧边栏宽度",
    "layout.resizeResourcePanel": "调整资源面板宽度",
    "layout.hideResourcePanel": "隐藏资源面板",
    "layout.resizeHint": "拖动调整宽度。双击或按 Enter 恢复默认值。",
    "sidebar.new": "新建",
    "sidebar.chatProjects": "项目",
    "sidebar.allChats": "所有聊天",
    "sidebar.activeChats": "活跃聊天",
    "sidebar.activeChatsTitle": "最近 {hours} 内活跃",
    "sidebar.configureActiveChats": "配置活跃聊天",
    "sidebar.activeChatsWindow": "活动时间范围",
    "sidebar.archivedChats": "已归档",
    "sidebar.newChatProject": "新建聊天项目",
    "sidebar.chatProjectName": "项目名称",
    "sidebar.createChatProject": "创建聊天项目",
    ...
    "sidebar.archiveChat": "归档聊天",
    "sidebar.unarchiveChat": "取消归档",
    "sidebar.deleteChatProjectConfirm": "删除此聊天项目？其中的聊天仍会保留。",
    "sidebar.chatProjectAcrossDirectories": "包含 {count} 个目录",
    "sidebar.reorderChatProject": "重新排序 {name}",
    "sidebar.reorderChatProjectHint": "拖动以重新排序。按上箭头或下箭头移动。",
    ...
    "chat.turnDuration": "本轮 {duration}",
    "chat.totalDuration": "总用时 {duration}",
    ...
    "chat.branchInNewChat": "在新对话中创建分支",
    ...
    "i18n.disableSyntaxHighlighting": "停用语法高亮",
    "i18n.enableSyntaxHighlighting": "为这个大文件启用语法高亮",
    ...
    "i18n.editingFromHere": "正在从此处编辑，后续消息在你发送前会隐藏。",
    "i18n.newSession": "在新对话中创建分支",
    "i18n.newSessionTitle": "在新对话中创建分支，从此处复制会话",
