...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.saveDisplayName": "儲存",
    "settings.appUpdate": "應用程式更新",
    "settings.checkForUpdatesDescription": "檢查已發佈版本，或從本機 Pi Web 原始碼重新建置。",
    "settings.sourceDirectory": "原始碼目錄",
    "settings.updateAvailable": "版本 {latest} 可用。目前版本為 {current}。",
    "settings.upToDate": "版本 {current} 已是最新。",
    "settings.updateAndReload": "更新並重新載入",
    "settings.updatingApp": "正在更新…",
    "settings.updateMacOnly": "自動更新和重新載入目前僅支援 macOS。",
    "settings.generalDescription": "選擇 Seb 的外觀與介面語言。",
    ...
    "settings.themeSepia": "茶紙",
    "settings.themeEmber": "餘燼",
    "settings.themeSlate": "青灰",
    ...
    "agents.close": "關閉",
    "agents.builtInTitle": "啟用 Seb 內建子代理",
    "agents.builtInDescription": "提供 Seb 整合的 Agent 工具，並停用發生衝突的 pi-subagents 擴充功能。",
    ...
    "agentSwitcher.noAgents": "尚未啟動 Agent",
    "agents.showWorkspace": "顯示 Agents 工作區",
    "agents.hideWorkspace": "隱藏 Agents 工作區",
    ...
    "appUpdate.releaseNotes": "Seb v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    "theme.light": "主題：淺色",
    "theme.dark": "主題：深色",
    ...
    "session.timing": "耗時",
    "session.modelTime": "模型",
    "session.toolTime": "工具",
    "session.currentTask": "目前任務",
    "session.taskBreakdown": "{count} 個任務",
    "session.task": "任務 {count}",
    ...
    "files.hidePreview": "隱藏即時預覽",
    "files.showPreview": "顯示即時預覽",
    "files.previewUnavailable": "預覽無法使用",
    "files.panel": "檔案",
    "files.noPreviews": "沒有開啟的預覽",
    "files.noneOpen": "沒有開啟的檔案",
    "layout.resizeSidebar": "調整側邊欄寬度",
    "layout.resizeResourcePanel": "調整資源面板寬度",
    "layout.hideResourcePanel": "隱藏資源面板",
    "layout.resizeHint": "拖曳以調整寬度。按兩下或按 Enter 鍵即可重設。",
    "sidebar.new": "新增",
    "sidebar.chatProjects": "專案",
    "sidebar.allChats": "所有聊天",
    "sidebar.activeChats": "活躍聊天",
    "sidebar.activeChatsTitle": "最近 {hours} 內活躍",
    "sidebar.configureActiveChats": "設定活躍聊天",
    "sidebar.activeChatsWindow": "活動時間範圍",
    "sidebar.archivedChats": "已封存",
    "sidebar.newChatProject": "新增聊天專案",
    "sidebar.chatProjectName": "專案名稱",
    "sidebar.createChatProject": "建立聊天專案",
    "sidebar.moveToProject": "移動到專案",
    "sidebar.removeFromProject": "從專案中移除",
    "sidebar.chatActions": "聊天操作",
    "sidebar.pinChat": "置頂聊天",
    "sidebar.unpinChat": "取消置頂",
    "sidebar.archiveChat": "封存聊天",
    "sidebar.unarchiveChat": "取消封存",
    "sidebar.deleteChatProjectConfirm": "刪除此聊天專案？其中的聊天仍會保留。",
    "sidebar.chatProjectAcrossDirectories": "包含 {count} 個目錄",
    "sidebar.reorderChatProject": "重新排序 {name}",
    "sidebar.reorderChatProjectHint": "拖曳以重新排序。按向上鍵或向下鍵移動。",
    ...
    "chat.turnDuration": "本輪 {duration}",
    "chat.totalDuration": "總用時 {duration}",
    ...
    "i18n.editingFromHere": "正在從此處編輯，後續訊息在你傳送前會隱藏。",
    "i18n.newSession": "在新對話建立分支",
    "i18n.newSessionTitle": "在新對話建立分支，從此處複製工作階段",
