...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Seb looks and which language it uses.",
    "settings.displayName": "Display name",
    "settings.displayNamePlaceholder": "Seb",
    "settings.saveDisplayName": "Save",
    "settings.appUpdate": "App update",
    "settings.checkForUpdatesDescription": "Check the published version or rebuild from a local Pi Web source tree.",
    "settings.sourceDirectory": "Source directory",
    "settings.updateAvailable": "Version {latest} is available. You have {current}.",
    "settings.upToDate": "Version {current} is up to date.",
    "settings.updateAndReload": "Update & reload",
    "settings.updatingApp": "Updating…",
    "settings.updateMacOnly": "Automatic update and reload is currently available on macOS only.",
    ...
    "settings.themeRoséPine": "Rosé Pine",
    "settings.themeRoséPineDawn": "Rosé Pine Dawn",
    "settings.themeAbsolutely": "Absolutely",
    "settings.themeAyuDark": "Ayu Dark",
    "settings.themeAyuLight": "Ayu Light",
    "settings.themeCatppuccinLatte": "Catppuccin Latte",
    "settings.themeCatppuccinMocha": "Catppuccin Mocha",
    "settings.themeCodex": "Codex",
    ...
    "settings.themeMaterialLighter": "Material Lighter",
    "settings.themeMaterialOcean": "Material Ocean",
    "settings.themeMonokai": "Monokai",
    "settings.themeNightOwl": "Night Owl",
    "settings.themeNord": "Nord",
    "settings.themeOneDark": "One Dark",
    "settings.themePoimandres": "Poimandres",
    "settings.themeRosePine": "Rosé Pine",
    "settings.themeRosePineDawn": "Rosé Pine Dawn",
    "settings.themeSolarizedDark": "Solarized Dark",
    "settings.themeSolarizedLight": "Solarized Light",
    "settings.themeTokyoDay": "Tokyo Day",
    "settings.themeTokyoNight": "Tokyo Night",
    "settings.themeVercel": "Vercel",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Seb built-in sub-agents",
    "agents.builtInDescription": "Provides Seb's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "agentSwitcher.noAgents": "No agents spawned yet",
    "agents.showWorkspace": "Show agents workspace",
    "agents.hideWorkspace": "Hide agents workspace",
    ...
    "appUpdate.releaseNotes": "Seb v{version} is available. View release notes",
    ...
    "session.modelTime": "Model",
    "session.toolTime": "Tools",
    "session.currentTask": "Current task",
    "session.taskBreakdown": "{count} tasks",
    "session.task": "Task {count}",
    ...
    "files.hidePreview": "Hide live preview",
    "files.showPreview": "Show live preview",
    "files.previewUnavailable": "Preview unavailable",
    "files.panel": "Files",
    "files.noPreviews": "No previews open",
    "files.noneOpen": "No file open",
    "layout.resizeSidebar": "Resize sidebar",
    "layout.resizeResourcePanel": "Resize resource panel",
    "layout.hideResourcePanel": "Hide resource panel",
    "layout.resizeHint": "Drag to resize. Double-click or press Enter to reset.",
    "sidebar.new": "New",
    "sidebar.chatProjects": "Projects",
    "sidebar.allChats": "All chats",
    "sidebar.activeChats": "Active chats",
    "sidebar.activeChatsTitle": "Active in the last {hours}",
    "sidebar.configureActiveChats": "Configure active chats",
    "sidebar.activeChatsWindow": "Activity window",
    "sidebar.archivedChats": "Archived",
    "sidebar.newChatProject": "New chat project",
    "sidebar.chatProjectName": "Project name",
    "sidebar.createChatProject": "Create chat project",
    ...
    "sidebar.unarchiveChat": "Unarchive chat",
    "sidebar.deleteChatProjectConfirm": "Delete this chat project? Its chats will stay available.",
    "sidebar.chatProjectAcrossDirectories": "Includes {count} directories",
    "sidebar.reorderChatProject": "Reorder {name}",
    "sidebar.reorderChatProjectHint": "Drag to reorder. Press Up or Down to move.",
    ...
    "chat.totalDuration": "Total time {duration}",
    ...
    "chat.branchInNewChat": "Branch in new chat",
    ...
    "i18n.editingFromHere": "Editing from here — later messages are hidden until you send.",
    "i18n.newSession": "Branch in new chat",
    "i18n.newSessionTitle": "Branch in new chat — copies the conversation up to here",
