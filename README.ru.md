...
- **Два способа создать ветку**: **Branch in new chat** создаёт независимый файл сессии из более раннего сообщения ассистента или выделенного текста, а **Edit from here** создаёт ветку внутри текущей сессии.
- **Инструменты для файлов проекта**: просмотр и загрузка файлов, проверка Git Diff, предпросмотр исходного кода, Markdown, изображений, аудио, PDF и DOCX с автоматическим обновлением; для больших или усечённых файлов исходного кода можно включить подсветку синтаксиса.
